...
def authorize_password(password: str, auth_info: UserPassword):
    # return str.encode(password) == Fernet(str.encode(auth_info.salt)).decrypt(str.encode(auth_info.hash))

    # entered_password = password.encode('utf-8')
    # hashed_password = base64.b64decode(auth_info.hash.encode('utf-8'))

    # return bcrypt.checkpw(entered_password, hashed_password)

    return bcrypt.checkpw(password.encode(), auth_info.hash.encode())
