...
from app0.admin.util import (ACT_USER_DELETE_USER, ACT_USER_CREATE, IDX_USER_ROLE,
                             IDX_USER, ROLE_ADMIN, ROLE_USER, IDX_NOTIFICATION)
from app0.admin.util.user_util import save_user
...
async def _user_create(es, user: User, context: EventContext):
    ...
    user_app_role = UserAppRole(user.username, ROLE_USER)
