...
class ObjectStorageConnConfig:
    ...
    endpoint_url: str
    use_ssl: Union[str, bool] = field(default=True)
...
class ObjectStorage():
    ...
    async def put(self, file_obj, key: str) -> Optional[FileInfo]:
        """
        ...
        return FileInfo(self._bucket, key, 0)

    async def store(self, key: str, file_obj):
        """
        Upload a file-like object to S3.
        ...
        with open('filename', 'rb') as data:
            object_sotage.store('mykey', data)
