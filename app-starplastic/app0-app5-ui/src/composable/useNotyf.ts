...
export const useNotyf = createSharedComposable(() => {
  ...
  return {
    ...
    successNoClose: (payload: string | Partial<INotyfNotificationOptions>) => {
      return notyfNoClose.success(payload)
    },
    error: (payload: string | Partial<INotyfNotificationOptions>) => {
      return notyfNoClose.error(payload)
    },
    ...
    infoNoClose: (payload: string | Partial<INotyfNotificationOptions>) => {
      const options: Partial<INotyfNotificationOptions> = {
        type: 'info',
      }
      ...
      return notyfNoClose.open(options)
    },
