...
const validateForm = () => {
  ...
  return !vErrors.value.firstname && !vErrors.value.surname && !vErrors.value.email
}
const onSave = async () => {
...
<template>
  ...
  <VModal :open="confirmDeleteUser" title="Confirmar acción" size="small" @close="confirmDeleteUser = false">
    <template #content>
      <VPlaceholderSection title="" subtitle="¿Está seguro de eliminar al usuario de la plataforma?" />
    </template>
    <template #action>
      <VButton color="danger" raised @click="onDeleteUser">Confirmar</VButton>
    </template>
  </VModal>
  <VModal :open="confirmDeleteRole" title="Confirmar acción" size="small" @close="confirmDeleteRole = false">
    <template #content>
      <VPlaceholderSection
        title=""
        :subtitle="'¿Está seguro de eliminar el rol ' + tempDeleteRole.role + ' del usuario?'"
      />
    </template>
    <template #action>
      <VButton color="primary" raised @click="onDeleteUserRole">Confirmar</VButton>
    </template>
  </VModal>
