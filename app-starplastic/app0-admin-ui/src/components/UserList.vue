...
<template>
  ...
  <div class="list-flex-toolbar flex-list-v1">
    <VField addons>
      <VControl expanded>
        <input v-model="searchText" type="text" class="input" placeholder="Ingrese filtros..." @keyup.enter="getData" />
      </VControl>
      <VControl>
        <VButton color="info" icon="fas fa-search" raised elevated @click="getData"> Buscar </VButton>
      </VControl>
    </VField>
  ...
  <span v-if="pagination.total == 0">No se encontraron resultados</span>
</template>
