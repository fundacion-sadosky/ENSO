...
<template>
  <div class="sidebar-layout">
      ...
      <template #links>
        <li v-if="isAdmin">
          <RouterLink :to="{ name: 'apps' }">
            <i aria-hidden="true" class="iconify" data-icon="icon-park-outline:all-application"></i>
          </RouterLink>
        </li>
        <li v-if="isAdmin">
    ...
    <Sidebar :theme="props.theme" :is-open="isDesktopSidebarOpen">
      <template #links>
        <li v-if="isAdmin">
          <RouterLink id="apps" :to="{ name: 'apps' }" data-content="Apps">
            <i aria-hidden="true" class="iconify sidebar-svg" data-icon="icon-park-outline:all-application"></i>
          </RouterLink>
        </li>
        <li v-if="isAdmin">
          <RouterLink id="users" :to="{ name: 'users' }" data-content="Usuarios">
