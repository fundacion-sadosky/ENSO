  ...
  if (!isLoading.value) {
    ...
    try {
      if (validateForm()) {
        ...
        if (ret.status == 200) {
          notyf.success('Contraseña seteada correctamente')
          router.push({ name: 'login' })
        } else {
          notyf.error('Se produjo un Error al setear la contraseña')
        }
      }
    } catch (error: any) {
...
useHead({
  title: 'Configuración inicial de la contraseña en la Plataforma',
})
</script>
    ...
    <div class="auth-wrapper-inner is-single">
      ...
      <div class="single-form-wrap">
        <div class="inner-wrap">
          ...
          <div class="auth-head">
            <h2>Establecer su contraseña de usuario</h2>
          </div>
            ...
            <form @submit.prevent>
              <div class="login-form">
                ...
                <VMessage v-if="vErrors.min_length" color="danger"
                  >Los campos Nueva contraseña y Repetir nueva contraseña son obligatorios y deben tener una longitud
                  mínima de 6 caracteres</VMessage
                >
                <VMessage v-if="vErrors.mismatch" color="danger"
                  >Los campos Nueva contraseña y Repetir nueva contraseña deben contener el mismo valor</VMessage
                >
              </div>
            </form>
          </div>
