...
environment variables `APP0_APP_VERSION` and `CA_APP_APPS_API_VERSION` are set.
"""
import os
import sys

APP0_APP_NAME = "app0.app5"
APP0_APP_VERSION = "0.4.6"

# Major.Minor version to be used in App versions and Api endpoints for Apps/Plugins
APPS_API_VERSION = '.'.join(APP0_APP_VERSION.split('.')[0:2])
APPS_ROUTE_VERSION = APPS_API_VERSION.replace('.', 'x')

os.environ['APP0_APP_VERSION'] = APP0_APP_VERSION
os.environ['APP0_APP_API_VERSION'] = APPS_API_VERSION
os.environ['APP0_APP_ROUTE_VERSION'] = APPS_ROUTE_VERSION
